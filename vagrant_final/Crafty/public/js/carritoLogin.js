...
if (utils.containerProductCart != null) {
    utils.containerProductCart.addEventListener("click", async function (e) {
        if (e.target.classList.contains("eliminar")) {
            ...
            utils.removeArrayLocalStorage(idProducto, utils.arrayProductos);
            await utils.guardarEliminarProduct();
...
if (!sessionStorage.getItem("limpiarStorageLogin")) {
    localStorage.clear();
    sessionStorage.setItem("limpiarStorageLogin", true);
}

//Eliminar el localStorage cuando cierra sesión
